...
@section('h1_Dashboard', 'Books')
@section('main')
<script src="{{ asset('js/bookstore/bookstore.js') }}" type="module" defer></script>
...
<main class="flex flex-col p-4">
    ...
    <section class="flex flex-col p-2">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="/library/bookstore/send-export" method="post">
                            @csrf
                            <div space-y-2>
        ...
        @if (isset($object) || !empty($object))
            <div class="flex">
                <form action="/library/bookstore/put/{{$object->id}}" method="POST" id="form_home" enctype="multipart/form-data"
                    class="flex flex-row w-full justify-center items-center gap-6 mb-12">
                    @csrf
                    <div class="flex flex-row w-full justify-center items-center gap-6 mb-12">
                        <div class="w-full space-y-6">
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">ISBN</label>
                                    <div class="mt-2">
                                        <input type="text" name="ISBN" value="{{$object->ISBN}}" placeholder="ISBN..."
                                            id="ISBN" autocomplete="given-name"
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">Editora</label>
                                    <select id="selectPublisher" name="publisher" required
                                        class="block w-full pl-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                                        <option disabled selected value="">Editora...</option>
                                        @if($publishers)
                                            @foreach ($publishers as $publisher)
                                                @if ($object->id_publisher == $publisher->id)
                                                    <option value="{{$publisher->id}}" selected class="text-white">
                                                        {{$publisher->name}}
                                                    </option>
                                                @endif
                                                <option value="{{$publisher->id}}" class="text-white">{{$publisher->name}}</option>
                                            @endforeach
                                        @endif
                                        @if (empty($publishers))
                                            <option disabled selected>Não há Editoras!</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">Autores(as)</label>
                                    <select multiple="multiple"
                                        class="tags block w-full pl-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
                                        required id="tags" name="authors[]" multiple data-coreui-search="true">
                                        @if($authors)
                                            @foreach ($authors as $author)
                                                <option class="select select-bordered w-full" value="{{$author->id}}">
                                                    {{$author->name}}
                                                </option>
                                            @endforeach
                                        @endif
                                        @if (empty($authors))
                                            <option disabled selected>Não há Autores!</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">Preço</label>
                                    <div class="mt-2">
                                        <input type="text" name="price" value="{{$object->price}}" placeholder="Preço..." id="price"
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">Bibliografia</label>
                                    <textarea placeholder="Digite aqui..." name="bibliography" value="{{$object->bibliography}}" 
                                        style="resize: none;  height: 100px;"
                                        class="block w-full p-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"></textarea>
                                </div>
                            </div>
                        </div>

                        <aside class="flex flex-col  w-full justify-center items-center gap-6 mb-12">
                            <div class="w-4/5 col-span-full justify-center ">
                                ...
                                <div
                                    ...
                                    <div class="text-center">
                                        @if($object->image)
                                            <img src="/image/bookstore/{{ $object->image ?? '784568SemImagem.png'}}" class="w-full h-auto  mb-4"
                                        ...
                                        <div class="mt-4 flex text-sm/6 text-gray-600">
                                            <label for="file-upload"
                                                ...
                                                <input  name="image" accept="image/png, image/jpeg, image/jpg" type="file">
                                            </label>
                                        </div>
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">Nome</label>
                                    <div class="mt-2">
                                        <input type="text" name="name" value="{{$object->name}}" placeholder="Nome..." id="name"
                                            autocomplete="given-name"
                                            class="block w-full pl-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                                    </div>
                                </div>
        ...
        @if (empty($object))
            <div class="flex">
                <form action="/library/bookstore" method="POST" id="form_home" enctype="multipart/form-data"
                    class="flex flex-row w-full justify-center items-center gap-6 mb-12">
                    @csrf
                    <div class="flex flex-row w-full justify-center items-center gap-6 mb-12">
                        <div class="w-full space-y-6">
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    ...
                                    <select id="selectPublisher" name="publisher" required
                                        ...
                                        @if($publishers)
                                            @foreach ($publishers as $publisher)
                                                <option value="{{$publisher->id}}" class="text-balck">{{$publisher->name}}</option>
                                            @endforeach
                                        @endif
                                        @if (empty($publishers))
                                            <option disabled selected>Não há Editoras!</option>
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    ...
                                    <select multiple="multiple"
                                        class="block w-full pl-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
                                        required id="bookSelect" name="authors[]" multiple data-coreui-search="true">
                                        @if($authors)
                                            @foreach ($authors as $author)
                                                <option class="select select-bordered w-full" value="{{$author->id}}">
                                                    {{$author->name}}
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">Preço</label>
                                    <div class="mt-2">
                                        <input type="text" name="price" placeholder="Preço..." id="price"
                                            autocomplete="given-name"
                                            class="block w-full pl-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                                    </div>
                                </div>
                            ...
                            <div class="flex justify-center itens-center w-full ">
                                <div class="w-4/5 sm:col-span-3">
                                    <label class="block text-sm/6 font-medium text-gray-900">Bibliografi</label>
                                    <textarea placeholder="Digite aqui..." name="bibliography"
                                        style="resize: none;  height: 100px;"
                                        class="block w-full p-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"></textarea>
                                </div>
                            </div>
            ...
            <div>
                ...
                <div class="flex flex-row mb-12 text-white justify-between space-x-10">
                    <span class="flex w-1/2 pl-4 space-x-4 items-center">
                        <span class="flex space-x-4">
                            ...
                            <form action="/library/bookstore" method="get">
                                @csrf
                                <select name="show" id="selectShow" class="text-[#1D232A]" onchange="this.form.submit();">
                        ...
                        <span class="flex">
                            <form action="/library/bookstore/search" id="orderForm" method="GET"
                    ...
                    <span class="flex w-1/2  pl-36">
                        <form id="FormSearch" action="/library/bookstore/search" method="GET" class=" flex max-w-md mx-auto w-full justify-between space-x-6 ">
                ...
                <div class="flex w-full justify-between">
                    ...
                    <span class="flex w-full pl-6 justify-end items-center">
                        ...
                        <form action="/library/bookstore/export" method="get">
                            @csrf
                            <button type="submit"
                                class="text-white bg-[#1D232A] hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                                Export Excel
                            ...
                            <li class="flex justify-between text-black gap-x-6 py-5">
                                ...
                                <div class="flex gap-x-4 space-x-6 w-[60px]">
                                    <img class="size-12 flex-none bg-gray-200 justify-center text-center items-center  "
                                        src="
                                    @if ($data->image)
                                        /image/books/{{ $data->image }}
                                    @else
                                        /image/784568SemImagem.png
                                    @endif
                                    " alt="{{ $data->name }}">
                                </div>
...
@else
    <p class="text-center text-white text-2xl">No books found</p>
@endif

                <div class="flex flex-col">
                    <div class="m-4 mb-8 space-y-2">
                         <h5 class="text-xl font-semibold text-black">Relação Editoras</h5>
                    </div>

                <article class="w-full pl-6 pr-6 m-auto bg-gray-800 max-h-96 overflow-y-auto ">
                    <ul role="list" class="divide-y divide-gray-100 max-h-96 overflow-y-auto ">
                        @if ($relationship)
                        @foreach ($relationship as $publishership)
                                                <li class="flex justify-between text-black gap-x-6 py-5">
                                                    <div class="flex min-w-0 gap-x-4 pl-6 w-[60px]">
                                                        <div class="flex justify-center items-center space-x-4 ">
                                                            <p class="flex text-sm/6 font-semibold text-white text-center">{{ $publishership->id_books}}</p>
                                                            <p class="flex text-sm/6 font-semibold text-white text-center">{{ $publishership->name}}</p>
                                                        </div>
                                                    </div>
                                                    <div class="flex min-w-0 gap-x-4 pl-6">
                                                        <div class="flex justify-center items-center ">
                                                            <p class="flex text-sm/6 font-semibold text-white text-center">{{ $publishership->id_p}}</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="flex min-w-0 gap-x-4 space-x-6  w-[60px] justify-center ">
                                                    <div class="flex justify-center items-center ">
                                                        <p class="flex text-sm/6 font-semibold text-wrap text-white text-center">
                                                        {{ $publishership->name_p}}
                                                        </p>
                                                    </div>
                                                </div>

                                    <div class="flex gap-x-4 space-x-6 w-[60px]">
                                    <img class="size-12 flex-none bg-gray-200 justify-center text-center items-center  " src="
                                    @if ($publishership->image_p)
                                        /image/publisher/{{ $publishership->image_p }}
                                    @else
                                        /image/784568SemImagem.png
                                    @endif
                                " alt="{{ $publishership->name_p }}">
                            </div>
                                                </li>
                        @endforeach
                        @else
                 ...
                 <div class="flex flex-col">
                        <div class="m-4 mb-8 space-y-2">
                            <h3 class="text-xl font-semibold text-black">Relação Autores(as)</h3>
                        </div>
                        ...
                        <article class="w-full pl-6 pr-6 m-auto bg-gray-800 max-h-96 overflow-y-auto ">
                            ...
                            <ul role="list" class="divide-y divide-gray-100 max-h-96 overflow-y-auto ">
                                ...
                                @foreach ($relationshipAuthors as $authorship)
                                    <li class="flex justify-between text-black gap-x-6 py-5">
                                            <div class="flex min-w-0 gap-x-4 pl-6 w-[60px]">
                                                <div class="flex justify-center items-center space-x-4 ">
                                                    <p class="flex text-sm/6 font-semibold text-white text-center">{{ $authorship->book_ids}}</p>
                                                    <p class="flex text-sm/6 font-semibold text-white text-center">{{ $authorship->book_names}}</p>
                                                </div>
                                            </div>
                                            <div class="flex min-w-0 gap-x-4 pl-6 w-[60px]">
                                                <div class="flex justify-center items-center ">
                                                    <p class="flex text-sm/6 font-semibold text-white text-center">{{ $authorship->id_author}}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex gap-x-4 space-x-6 w-[60px]">
                                                <img class="size-12 flex-none bg-gray-200 justify-center text-center items-center  " src="
                                                    @if ($authorship->author_image)
                                                        /image/authors/{{ $authorship->author_image }}
                                                    @else
                                                        /image/784568SemImagem.png
                                                    @endif
                                                " alt="{{ $authorship->author_name }}">
                                        </div>
                                    </li>
                                @endforeach
                                @else
