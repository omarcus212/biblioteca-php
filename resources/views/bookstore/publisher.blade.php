...
@section('h1_Dashboard', 'Publisher')
@section('main')
<script src="{{ asset('js/bookstore/publisher.js') }}" type="module" defer></script>
...
<main class="flex flex-col p-4">
    ...
    <section class="flex flex-col p-2">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="/library/publisher/send-export" method="post">
                            @csrf
                            <div space-y-2>
        ...
        @if (isset($object) || !empty($object))
            <div class="flex">
                <form action="/library/publisher/put/{{$object->id}}" method="POST" id="form_home"
                    ...
                    <div class="w-1/2 col-span-full justify-center ">
                        ...
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                            <div class="text-center">
                                @if($object->image)
                                    <img src="/image/publisher/{{ $object->image ?? '784568SemImagem.png'}}"
        ...
        @if (empty($object))
            <div class="flex">
                <form action="/library/publisher" method="POST" id="form_home" enctype="multipart/form-data"
            ...
            <div>
                <div class="flex flex-row mb-12 text-white justify-between space-x-10">
                    ...
                    <span class="flex w-1/2  pl-36">
                        <form id="FormSearch" action="/library/publisher/search" method="GET"
                ...
                <div class="flex w-full justify-between">
                    ...
                    <span class="flex w-full pl-6 justify-end items-center">
                        ...
                        <form action="/library/publisher/export" method="get">
                            @csrf
                            <button type="submit"
                                class="text-white bg-[#1D232A] hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                                Export Excel
                                            ...
                                            <li class="flex justify-between text-black gap-x-6 py-5">
                                                ...
                                                <div class="flex gap-x-4 space-x-6 w-[60px]">
                                                    <img class="size-12 flex-none bg-gray-200 justify-center text-center items-center  "
                                                        src="/image/publisher/{{ $data->image ?? '784568SemImagem.png' }}"
                                                        alt="{{ $data->name }}">
                                                </div>
                    ...
                    <ul role="list" class="divide-y divide-gray-100 max-h-96 overflow-y-auto ">
                        ...
                        @foreach ($relationship as $books)
                            <li class="flex justify-between text-black gap-x-6 py-5">
                                ...
                                <div class="flex gap-x-4 space-x-6 w-[60px]">
                                    <img class="size-12 flex-none bg-gray-200 justify-center text-center items-center  "
                                        src="/image/books/{{ $books->image ?? '784568SemImagem.png' }}"
                                        alt="{{ $books->name }}">
                                </div>
                            </li>
                        @endforeach
